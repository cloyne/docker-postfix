...
docker run --detach=true --restart=always --name mail --hostname mail.cloyne.net \
 --publish 64.62.133.44:25:25/tcp --publish 64.62.133.44:465:465/tcp --publish 64.62.133.44:587:587/tcp \
 --env MAILNAME=mail.cloyne.net \
 --env MY_NETWORKS='10.20.32.0/22 172.17.0.0/16 64.62.133.40/29 127.0.0.0/8' \
